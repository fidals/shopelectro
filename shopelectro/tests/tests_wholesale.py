...
class SECartTest(TestCase):
    ...
    def test_add_wholesale_small(self):
        ...
        """
        self.run_add_test(
            *self.prepare_add_test(
                self.setup_for_tests('wholesale_small')
            )
        )
    ...
    def test_add_wholesale_medium(self):
        ...
        self.run_add_test(
            *self.prepare_add_test(
                self.setup_for_tests('wholesale_medium')
            )
        )
    ...
    def test_add_wholesale_large(self):
        ...
        self.run_add_test(
            *self.prepare_add_test(
                self.setup_for_tests('wholesale_large')
            )
        )
    ...
    def test_remove_wholesale_small_to_price(self):
        ...
        20 000 rub. then price for every product equated default price.
        """
        self.run_remove_test(
            *self.prepare_remove_test(
                *self.prepare_for_before_and_after_test(
    ...
    def test_remove_wholesale_medium_to_wholesale_small(self):
        ...
        50 000 rub. then price for every product equated small price.
        """
        self.run_remove_test(
            *self.prepare_remove_test(
                *self.prepare_for_before_and_after_test(
    ...
    def test_set_wholesale_small_to_price(self):
        ...
        20 000 rub. then price for every product equated default price.
        """
        self.run_dec_set_test(*self.prepare_for_before_and_after_test(
            'wholesale_small', 'price'
        ))
    ...
    def test_set_price_to_wholesale_small(self):
        ...
        20 000 rub. then price for every product equated default price.
        """
        self.run_inc_set_test(*self.prepare_for_before_and_after_test(
